...
Select f.nome, f.lider, l.nome as nome_lider, f.ideologia from faccao f join lider l
on f.lider=l.CPI;

-- A view criada é atualizavel pois existe a preservação de chave da tabela faccao e da tabela lider, logo, é possivel fazer atulização, inserções e deleçoes através da view

--b)
insert into lider values('777.777.777-72', 'teste1_view', 'CIENTISTA', 'Nam ut a.', 'Non eos qui');
-- inserção de teste

insert into view_faccao_lider values('Teste1_view','777.777.777-72','teste1-view','TRADICIONALISTA');
-- não é possível, pois estou tentado modificar duas tabelas base, Lider e Facção

insert into view_faccao_lider (nome,lider,ideologia) values ('Teste1_view','777.777.777-72', 'TRADICIONALISTA');
-- é possivel pois estou modificando apenas uma tabela base, Faccao

-- atualização:
update view_faccao_lider set nome = 'TESTE1' where nome = 'Teste1_view';
-- possivel, atualiza a tabela base

-- remoção:
delete from view_faccao_lider where nome = 'TESTE1';
